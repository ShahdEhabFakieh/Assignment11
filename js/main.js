let todayName = document.getElementById("Date_name")
let todayMonth = document.getElementById("Date_number_month")
let todayLocation = document.getElementById("today_location")
let todayTemp = document.getElementById("today_Temp")
let todayConditionImg = document.getElementById("today_condition_icon")
let todayConditionText = document.getElementById("condition_text")

let nextDay = document.getElementById("nextDay_name")
let nextMaxTemp = document.getElementById("next_max_temp")
let nextMinTemp = document.getElementById("next_min_temp")
let nextConditionImg = document.getElementById("next_condition_icon")
let nextConditionText = document.getElementById("next_condition_text")

let afterNextDay = document.getElementById("after_nextDay_name")
let afterNextMaxTemp = document.getElementById("after_next_max_temp")
let afterNextMinTemp = document.getElementById("after_next_min_temp")
let afterNextConditionImg = document.getElementById("after_next_condition_icon")
let afterNextConditionText = document.getElementById("after_next_condition_text")
